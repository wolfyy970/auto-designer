...
**Prompts and skills:** Treat [ARCHITECTURE.md](ARCHITECTURE.md) as the canonical technical reference for prompt resolution, package-owned skills, Pi skill loading, and task prompt assembly. Editing workflow and snapshots are in [USER_GUIDE.md § Prompts and skills](USER_GUIDE.md#prompts-and-skills-editing-the-repo).
