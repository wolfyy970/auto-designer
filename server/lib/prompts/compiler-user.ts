...
import { getSectionContent, collectImageLines } from './helpers.ts';
...
export function buildCompilerUserPrompt(
  ...
  if (existing && existing.length > 0) {
    ...
    prompt +=
      'The following strategies already exist. Do NOT reproduce them. Generate new strategies that explore genuinely different regions of the solution space.\n\n';
