...
- expresses_bet: Implementation supports the hypothesis at the scope its prose names, not just a generic landing page shell. (3 = generic page with a theme veneer. Cap at 2 when file count, page linking, or state coverage materially under-delivers — or sprawls past — the scope the hypothesis claims.)
